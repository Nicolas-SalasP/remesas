                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <?php if (isset($_SESSION['user_id'])): ?>
                        ...
                        <?php elseif (isset($_SESSION['user_rol_name']) && $_SESSION['user_rol_name'] === 'Operador'): ?>
                            <li class="nav-item"><a class="nav-link fw-bold text-primary" href="<?php echo BASE_URL; ?>/operador/pendientes.php">Ordenes Pendientes</a></li>
                            <li class="nav-item"><a class="nav-link fw-bold text-primary" href="<?php echo BASE_URL; ?>/operador/index.php">Ver todas las Ordenes</a></li>
                        <?php ?>
