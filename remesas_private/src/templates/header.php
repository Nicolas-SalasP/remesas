...
<head>
    ...
    <title><?php
    $defaultTitle = 'JC Envios | Envía Remesas Online Rápido y Seguro';
    echo isset($pageTitle) ? htmlspecialchars($pageTitle) . ' | JC Envios' : $defaultTitle;
    ?></title>
    <meta name="description"
        content="Envía dinero a tus seres queridos de forma rápida, segura y confiable con JC Envios. Las mejores tasas del mercado para tus remesas.">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white">
            <div class="container">
                <a class="navbar-brand logo" href="<?php echo BASE_URL; ?>/index.php">
                    <img src="<?php echo BASE_URL; ?>/assets/img/SoloLogoNegroSinFondo.png" alt="Logo JC Envios"
                        height="50">
                </a>
                ...
                <div class="collapse navbar-collapse" id="mainNavbar">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <?php if (isset($_SESSION['user_id'])): ?>
                            ...
                            <?php else: ?>
                                ...
                                <?php if (isset($_SESSION['user_rol_name']) && $_SESSION['user_rol_name'] === 'Admin'): ?>
                                    ...
                                    <li class="nav-item"><a class="nav-link fw-bold text-danger"
                                            href="<?php echo BASE_URL; ?>/admin/usuarios.php">Usuarios</a></li>
                                    <li class="nav-item"><a class="nav-link fw-bold text-danger"
                                            href="<?php echo BASE_URL; ?>/admin/">Órdenes</a></li>
                                    <li class="nav-item"><a class="nav-link fw-bold text-danger"
                                            href="<?php echo BASE_URL; ?>/admin/tasas.php">Tasas</a></li>

                                    <li class="nav-item"><a class="nav-link fw-bold text-danger"
                                            href="<?php echo BASE_URL; ?>/admin/cuentas.php">Cuentas</a></li>
                                    <li class="nav-item"><a class="nav-link fw-bold text-danger"
                                            href="<?php echo BASE_URL; ?>/admin/paises.php">Países</a></li>
                                    <li class="nav-item"><a class="nav-link fw-bold text-danger"
                                            href="<?php echo BASE_URL; ?>/admin/verificaciones.php">Verificaciones</a></li>
                                    <li class="nav-item"><a class="nav-link fw-bold text-danger"
                                            href="<?php echo BASE_URL; ?>/admin/logs.php">Logs</a></li>
                                ...
                                <?php elseif (isset($_SESSION['user_rol_name']) && $_SESSION['user_rol_name'] === 'Operador'): ?>
                                    <li class="nav-item"><a class="nav-link fw-bold text-primary"
                                            href="<?php echo BASE_URL; ?>/operador/pendientes.php">Transacciones Pendientes</a></li>
                                    <li class="nav-item"><a class="nav-link fw-bold text-primary"
                                            href="<?php echo BASE_URL; ?>/operador/index.php">Todas las Transacciones</a></li>

                                <?php else: ?>
                                    <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL; ?>/index.php">Inicio</a>
                                    </li>
                                    <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL; ?>/dashboard/">Realizar
                                            Transacción</a></li>
                                    <li class="nav-item"><a class="nav-link"
                                            href="<?php echo BASE_URL; ?>/dashboard/historial.php">Mi Historial</a></li>
                                    <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL; ?>/dashboard/perfil.php">Mi
                                            Perfil</a></li>
                                    <li class="nav-item"><a class="nav-link"
                        ...
                        <?php else: ?>
                            ...
                            <li class="nav-item"><a class="nav-link"
                                    href="<?php echo BASE_URL; ?>/quienes-somos.php">Quiénes Somos</a></li>
                            <li class="nav-item"><a class="nav-link"
                    ...
                    <div class="d-flex align-items-center">
                        <?php if (isset($_SESSION['user_id'])): ?>
                            ...
                            ?>
                            <img id="navbar-user-photo" src="<?php echo $photoUrl; ?>" alt="Foto de perfil"
